...
export const CatalogService =
  implementService.withConfig<CatalogServiceConfig>()(
    ...
    ({ getService }) => {
      ...
      const loadCatalogData = async (categoryId?: string): Promise<void> => {
        ...
        try {
          ...
          const [aggregationResponse, customizationsResponse] =
            await Promise.all([
...
export async function loadCatalogServiceConfig(): Promise<CatalogServiceConfig> {
  return {};
}
