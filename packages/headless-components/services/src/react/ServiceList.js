...
export const List = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(CoreServiceList.Root, { servicesListConfig: serviceConfig },
        React.createElement(ListContent, { children: children, className: className, ref: ref })));
});
...
export const ServiceRepeater = React.forwardRef((props, ref) => {
    ...
    if (!hasServices)
        return null;
    return (React.createElement(React.Fragment, null, services.map((service) => (React.createElement(Service.Root, { key: service._id, service: service, "data-testid": TestIds.serviceRepeater, "data-service-id": service._id }, children)))));
});
...
export const Error = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(CoreServiceList.Error, null, ({ error }) => {
        ...
        return (React.createElement(AsChildSlot, { ref: ref, asChild: asChild, className: className, "data-testid": TestIds.serviceError, "data-error": error, customElement: children, customElementProps: {
                error,
            }, content: error, ...otherProps },
            React.createElement("div", { className: "text-status-error text-sm sm:text-base" }, error)));
    }));
});
...
export const Service = {
    Root: React.forwardRef((props, ref) => {
        ...
        return (React.createElement(ServiceContext.Provider, { value: { service } },
            React.createElement("div", { "data-testid": TestIds.serviceRoot, ref: ref, ...rest }, children)));
    }),
    Name: React.forwardRef((props, ref) => {
        const { service } = React.useContext(ServiceContext);
        return (React.createElement("div", { "data-testid": TestIds.serviceName, ref: ref }, service.name));
    }),
    Description: React.forwardRef((props, ref) => {
        const { service } = React.useContext(ServiceContext);
        if (!service.description)
            return null;
        return (React.createElement("div", { "data-testid": TestIds.serviceDescription, ref: ref }, service.description));
    }),
    Price: React.forwardRef((props, ref) => {
        const { service } = React.useContext(ServiceContext);
        if (!service.price)
            return null;
        return (React.createElement("div", { "data-testid": TestIds.servicePrice, ref: ref },
    ...
    Duration: React.forwardRef((props, ref) => {
        ...
        if (!service.duration)
            return null;
        return (React.createElement("div", { "data-testid": TestIds.serviceDuration, ref: ref },
            service.duration,
            " minutes"));
    }),
    Image: React.forwardRef((props, ref) => {
        ...
        if (!service.imageUrl)
            return null;
        return (React.createElement("img", { src: service.imageUrl, alt: service.name, "data-testid": TestIds.serviceImage, ref: ref }));
    }),
    Category: React.forwardRef((props, ref) => {
        const { service } = React.useContext(ServiceContext);
        if (!service.category)
            return null;
        return (React.createElement("div", { "data-testid": TestIds.serviceCategory, ref: ref }, service.category));
    })
};
