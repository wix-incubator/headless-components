...
export const SelectedOptionServiceDefinition = defineService<SelectedOptionServiceAPI>("selectedOption");

export interface SelectedOptionServiceConfig {
  selectedOption: SelectedOption;
}

export const SelectedOptionService = implementService.withConfig<SelectedOptionServiceConfig>()(
 ...
 * ```
 */
export function isTextOption(option: SelectedOption): option is SelectedOptionText {
 ...
 * ```
 */
export function isColorOption(option: SelectedOption): option is SelectedOptionColor {
