            ...
            >
              <div className="bg-white/5 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/10 p-8 h-full hover:bg-white/10 transition-all duration-300">
                ...
                <p className="text-white/70 text-base leading-relaxed mb-6">
                  Comprehensive e-commerce experience with product browsing,
                  detailed product pages, cart functionality, and clean layout.
                  Perfect for showcasing Wix Stores capabilities with a
