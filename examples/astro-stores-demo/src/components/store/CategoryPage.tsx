...
export function CategoryPage({
  ...
  return (
    <>
      <Category.Root categoryServiceConfig={categoryServiceConfig}>
        <Category.Name>{({ name }) => <h1>{name}</h1>}</Category.Name>
      </Category.Root>
      <div>
        <h1>Categories</h1>
      </div>
      <CategoriesList.Root categoriesListConfig={categoriesListConfig}>
        ...
        <CategoriesList.Error>
          <div>Failed to load categories. Please try again.</div>
        </CategoriesList.Error>
