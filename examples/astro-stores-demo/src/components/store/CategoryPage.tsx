                ...
                return (
                  <GalleryWrapper
                    ...
                    itemRenderer={(item: BaseItem, index: number) => {
                      ...
                      // The itemRenderer returns Product.Root, we need to clone it with the product content
                      const productRoot = itemRenderer(originalItem, index);

                      // Clone the Product.Root and add the product content as children
                      return React.cloneElement(
                        productRoot as React.ReactElement,
                        {
                          children: (
