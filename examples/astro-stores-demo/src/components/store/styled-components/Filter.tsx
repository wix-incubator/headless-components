...
export const Root: React.FC<React.ComponentProps<typeof FilterPrimitive.Root>> = (props) => (
  <FilterPrimitive.Root {...props} />
);

export const Filtered: React.FC<React.ComponentProps<typeof FilterPrimitive.Filtered>> = ({ className, children, ...props }) => (
...
export const FilterOptions: React.FC<React.ComponentProps<typeof FilterPrimitive.FilterOptions>> = ({ className, children, ...props }) => (
...
export const FilterOptionRepeater: React.FC<React.ComponentProps<typeof FilterPrimitive.FilterOptionRepeater>> = ({ className, children, ...props }) => (
...
// Action Components
export const Action = {
  Clear: React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof FilterPrimitive.Action.Clear>>(
    ({ className, ...props }, ref) => (
...
export const FilterOption = {
  Label: React.forwardRef<HTMLDivElement, React.ComponentProps<typeof FilterPrimitive.FilterOption.Label>>(
  ...
  SingleFilter: React.forwardRef<HTMLElement, React.ComponentProps<typeof FilterPrimitive.FilterOption.SingleFilter>>(
    ({ className, ...props }, ref) => (
...
flex flex-wrap gap-2 [&_button]:transition-all [&_button]:cursor-pointer [&_button]:px-3 [&_button]:py-2 [&_button]:rounded-md [&_button]:text-sm [&_button]:font-medium [&_button]:border [&_button]:border-slate-300 [&_button]:bg-slate-50 [&_button]:text-slate-700 [&_button[data-state=on]]:bg-slate-900 [&_button[data-state=on]]:text-white [&_button[data-state=on]]:border-slate-900 [&_button[data-state=off]:hover]:bg-slate-100flex flex-wrap gap-2
  ...
  RangeFilter: React.forwardRef<HTMLElement, React.ComponentProps<typeof FilterPrimitive.FilterOption.RangeFilter>>(
    ({ className, ...props }, ref) => (
