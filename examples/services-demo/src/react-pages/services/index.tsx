          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ServiceList.Error>
              <div className="bg-status-danger-light border border-status-danger rounded-lg p-4 mb-6">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-status-danger">Error Loading Services</h3>
                    <p className="mt-2 text-sm text-status-danger">Failed to load services. Please try again later.</p>
                  </div>
                </div>
              </div>
            </ServiceList.Error>
            ...
            <ServiceList.Options emptyState={
              <div className="text-center py-16">
                ...
                <h3 className="mt-4 text-lg font-light text-content-primary">No Services Found</h3>
                <p className="mt-2 text-content-secondary">Try adjusting your filters or check back later.</p>
              </div>
            }>
                ...
                <ServiceList.ServiceRepeater>
                          <div className="bg-surface-card rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                            ...
                            <div className="p-6">
                              ...
                              {/* Learn More Link */}
                              <div className="mt-6">
                                <a href="#" className="block w-full bg-surface-primary text-content-primary text-center px-4 py-2 rounded-lg font-medium hover:bg-surface-secondary transition-colors">
                                  Learn more
                                </a>
                              </div>
                            </div>
