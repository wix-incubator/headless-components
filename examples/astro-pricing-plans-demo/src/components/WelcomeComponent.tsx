...
const WelcomeComponent: React.FC = () => (
  <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
    ...
    <main className="container mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-medium hover:shadow-large transition-all duration-300 hover:scale-105 border border-primary-100">
              ...
              <p className="text-secondary-600 leading-relaxed">
                Learn from master carpenters with decades of experience in both
                traditional and modern woodworking techniques.
              </p>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-medium hover:shadow-large transition-all duration-300 hover:scale-105 border border-primary-100">
              ...
              <p className="text-secondary-600 leading-relaxed">
                From basic joinery to advanced furniture making, our structured
                courses cover everything you need to become a skilled carpenter.
              </p>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-medium hover:shadow-large transition-all duration-300 hover:scale-105 border border-primary-100">
      ...
      <PricingPlans.Plan.Root planServiceConfig={{ planId: FEATURED_PLAN_ID }}>
        <PricingPlans.Plan.Plan className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 mx-auto flex gap-3">
