                ...
                <div className="flex gap-8">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex gap-1 font-light text-content-primary mb-3">
                      ...
                      <SchedulePrimitive.Stage className="font-light text-content-primary text-sm" />
                    </div>
                    <SchedulePrimitive.Tags className="flex gap-2 flex-wrap">
                      <SchedulePrimitive.TagItems className="flex gap-2 flex-wrap">
