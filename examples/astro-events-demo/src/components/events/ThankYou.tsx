    ...
    <div className="min-h-screen bg-surface-primary">
      <div className="max-w-5xl mx-auto p-15">
        ...
        <EventPrimitive.Root event={eventServiceConfig.event}>
          <OrderPrimitive.Root orderServiceConfig={orderServiceConfig}>
            <div className="mb-10">
              ...
              <EventPrimitive.Type asChild>
                {({ ticketed, rsvp }) => {
                  ...
                  if (ticketed) {
                    return (
                      <OrderPrimitive.GuestEmail asChild>
                        {({ guestEmail }) => (
                          <p className="font-light text-content-primary">
                      ...
                      if (ticketed) {
                        return (
                          <OrderPrimitive.DownloadTicketsButton asChild>
                            {({ ticketsPdfUrl }) => (
                              <button
                                className="font-light py-2 px-4 btn-primary h-fit"
                                onClick={() =>
                      ...
                      <>
                        <OrderPrimitive.InvoiceItems className="px-6 border-b border-gray-300">
                          ...
                          <div className="flex flex-row justify-end">
                            <div className="w-[40%]">
                              <div className="flex flex-col py-5 border-b border-gray-300 font-light text-content-primary">
