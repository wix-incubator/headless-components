      ...
      <div className="max-w-5xl mx-auto p-15">
        ...
        <Event event={eventServiceConfig.event}>
          <div className="flex justify-between">
            ...
            <EventRsvpButton asChild>
              {({ eventSlug, ticketed }) => (
                <a
                  href={`${eventsPagePath}/${eventSlug}`}
                  className="h-fit border border-secondary py-2 px-4 font-paragraph font-light text-foreground hover:underline bg-background inline-block text-center"
                >
        ...
        <ScheduleList scheduleListServiceConfig={scheduleListServiceConfig}>
          <ScheduleListFilters allStagesLabel="All stages">
            <FilterOptions>
              <FilterOptionRepeater className="flex flex-row justify-between mb-6 items-center">
          ...
          >
            <ScheduleListGroupRepeater>
              ...
              <ScheduleItemsGroupItems className="mt-4 space-y-4">
                <ScheduleItemsGroupItemRepeater className="group border border-secondary p-8 bg-background">
