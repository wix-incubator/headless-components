  ...
  return (
    <FilterPrimitive.FilterOption.MultiFilter
      ...
      className={cn(
        ...
        '[&_button]:px-3 [&_button]:py-1.5 [&_button]:border [&_button]:border-foreground/10 [&_button]:rounded-full [&_button]:bg-background hover:[&_button]:border-primary/80 hover:[&_button]:bg-primary/80',
