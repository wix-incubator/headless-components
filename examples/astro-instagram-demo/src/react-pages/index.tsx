                    ...
                    <div className="p-6 border-b border-foreground flex-1">
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center space-x-6">
                          <MediaGallery.Previous className="text-foreground text-2xl cursor-pointer">‹</MediaGallery.Previous>
                          <MediaGallery.Next className="text-foreground text-2xl cursor-pointer">›</MediaGallery.Next>
                        </div>
                      </div>
